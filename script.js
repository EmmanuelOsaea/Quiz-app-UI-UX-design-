const quizData = [
  {
    ...
    options: [' ', 'China', 'Spain', 'USA'],
    answer: ' ',
  },
  {
    question: 'What caused the first explosion in Rome?',
    options: [' ', ' ', ' ', ' '],
    answer: ' ',
  },
  {
    question: 'Which country made the first orange juice?',
    options: [' ', ' ', ' ', ' '],
    answer: ' ',
  },
  {
    question: 'Who was the first man to fly an air-balloon?',
    options: [' ', ' ', ' ', ' '],
    answer: ' ',
  },
  {
  ...
  {
    question: 'Who built the first ship in the world?',
    options: [
      ' ',
      ' ',
      ' ',
